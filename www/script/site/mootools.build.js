...
---
name: MilkboxDisplay
description: lightbox class
authors: Luca Reghellin
requires:
  - Core/Class
  - Core/Class.Extras

provides: MilkboxDisplay
...
*/
...
var MilkboxGallery = new Class({
	...
	check_extension:function(string){
		...
		regular_file = splitted.test(/\.(image|gif|jpg|jpeg|png|swf|html)$/i);
...
requires:
  ...
  - More/Array.Extras # TODO: check dependency
  - Core/DomReady # TODO: extract from base Milk
  - More/Swiff # TODO: extract from base Milk
  - More/String.QueryString # TODO: extract from base Milk (JSON gallery)
  - Core/Request # TODO: extract from base Milk (XML gallery)
  - MilkboxDisplay
  - MilkboxGallery
